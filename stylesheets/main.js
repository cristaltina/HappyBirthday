    ...
    function complete(i){ 
        if(i==0){
            ...
            addObj($(".picFrame>.picItem").eq(8),830,0,2000,'complete(8)')
        }else if(i==8){
            addObj($(".picFrame>.picItem").eq(9),0,1250,2000,'complete(9)')
        }else if(i==9){
	    addObj($(".picFrame>.picItem").eq(10),-830,0,2000,'complete(10)')
        }else if(i==10){
	    addObj($(".picFrame>.picItem").eq(11),830,-1250,2000,'complete(11)')
        }else if(i==11){
	    addObj($(".picFrame>.picItem").eq(12),-830,1250,2000,'complete(12)')
        }else if(i==12){
	    addObj($(".picFrame>.picItem").eq(13),0,-1250,2000,'complete(13)')
        }else if(i==13){
